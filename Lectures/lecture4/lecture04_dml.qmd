...
## A quick notation check: what does $O(\cdot)$ mean?
...
## Making the derivative precise, when $\eta$ is a function
...
## The symmetric case: perturbing $\pi$
...
Write $\phi_0(W_i) \equiv \psi(W_i;\theta_0,\eta_0)$ — the score, evaluated at the truth (same $\psi$ as always, just a shorter name for it here):
